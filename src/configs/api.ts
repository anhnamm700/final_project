...
export const API_PATHS = {
  ...
  getBrands: `${getBaseUrl(APIService.protected)}/brands/list`,
  getVendors: `${getBaseUrl(APIService.protected)}/vendors/list`,
  getConditions: `${getBaseUrl(APIService.protected)}/conditions/list`,
