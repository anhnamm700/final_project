...
function Pagination(props: Props) {
  const { pages, changeTotal, setCurrentPage } = props;
  ...
  return (
    <div className="pagination-container">
      <a
        ...
        onClick={() => setCurrentButton((prev: number) => prev <= 1 ? prev : prev - 1)}
      >
      ...
      <a
        ...
        onClick={() => setCurrentButton((prev: number) => prev >= numberOfPages.length ? prev : prev + 1)}
      >
